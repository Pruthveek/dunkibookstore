    ...
    <Link href={`/blogs/news/${blog.slug}`} className="group block">
      ...
      {isreadmorebutton ? (
        <div className="mb-8">
          ...
          <h3 className="mt-2 mb-4 text-xl hover:text-red-600 transform ease-in-out duration-1000 cursor-pointer">
            {blog.title}
          </h3>
          <h3 className="my-2 text-sm gap-2 cursor-pointer">
        ...
        <div>
          <h3 className=" mb-4 text-xl hover:text-red-600 transform ease-in-out duration-1000 cursor-pointer">
            {blog.title}
          </h3>
        </div>
      )}
